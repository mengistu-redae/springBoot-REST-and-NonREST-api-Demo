...
public class RestApiController {
	...
	public String getPage() {
		String welcomeMessage = "<div style=\"margin: 40 auto; width: 50%;\">"
				...
				+ "<ul>"
				+ "<li><a href=\"http://localhost:9090/swagger-ui/index.html\" target=\"_blank\">http://localhost:8080/swagger-ui/index.html</a></li>"
				+ "<li><a href=\"http://localhost:9090/v3/api-docs\" target=\"_blank\">http://localhost:8080/v3/api-docs</a></li>"
				+ "<li><a href=\"http://localhost:9090/v3/api-docs.yaml\" target=\"_blank\">http://localhost:8080/v3/api-docs.yaml</a></li>"
				+ "</ul>"
